...
const GenreItem = (props: GenreItemProps) => {
    ...
    let calculatedMarginLeft = useMemo(() => (forMovieCard ? 0 : (index === 0 || index % 4 === 0) && !forMovieCard) ? scale(20) : scale(5), [])
    return (
        <View style={[styles.container, { marginLeft: calculatedMarginLeft }]}>
